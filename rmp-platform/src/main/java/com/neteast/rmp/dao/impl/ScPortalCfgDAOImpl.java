...
@Repository
public class ScPortalCfgDAOImpl extends BaseSqlMapClientDaoSupport implements ScPortalCfgDAO {
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public Integer insert(ScPortalCfg record) {
        Object newKey = getSqlMapClientTemplate().insert("sc_portal_cfg.abatorgenerated_insert", record);
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public int updateByPrimaryKey(ScPortalCfg record) {
        int rows = getSqlMapClientTemplate().update("sc_portal_cfg.abatorgenerated_updateByPrimaryKey", record);
        return rows;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public int updateByPrimaryKeySelective(ScPortalCfg record) {
        int rows = getSqlMapClientTemplate().update("sc_portal_cfg.abatorgenerated_updateByPrimaryKeySelective", record);
        return rows;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public List selectByExample(ScPortalCfgExample example, String orderByClause) {
        Map parms = getExampleParms(example);
        if (orderByClause != null) {
            parms.put("ABATOR_ORDER_BY_CLAUSE", orderByClause);
        }
        List list = getSqlMapClientTemplate().queryForList("sc_portal_cfg.abatorgenerated_selectByExample", parms);
        return list;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public List selectByExample(ScPortalCfgExample example) {
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public ScPortalCfg selectByPrimaryKey(Integer id) {
        ScPortalCfg key = new ScPortalCfg();
        key.setId(id);
        ScPortalCfg record = (ScPortalCfg) getSqlMapClientTemplate().queryForObject("sc_portal_cfg.abatorgenerated_selectByPrimaryKey", key);
        return record;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public int deleteByExample(ScPortalCfgExample example) {
        int rows = getSqlMapClientTemplate().delete("sc_portal_cfg.abatorgenerated_deleteByExample", getExampleParms(example));
        return rows;
    }
    ...
    public int deleteByPrimaryKey(Integer id) {
        ScPortalCfg key = new ScPortalCfg();
        key.setId(id);
        int rows = getSqlMapClientTemplate().delete("sc_portal_cfg.abatorgenerated_deleteByPrimaryKey", key);
        return rows;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getIDExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
        switch (example.getId_Indicator()) {
        case ScPortalCfgExample.EXAMPLE_NULL:
            ...
            break;
        case ScPortalCfgExample.EXAMPLE_NOT_NULL:
            if (example.isCombineTypeOr()) {
            ...
            break;
        case ScPortalCfgExample.EXAMPLE_EQUALS:
            if (example.isCombineTypeOr()) {
            ...
            break;
        case ScPortalCfgExample.EXAMPLE_NOT_EQUALS:
            if (example.isCombineTypeOr()) {
            ...
            parms.put("id", example.getId());
            break;
        case ScPortalCfgExample.EXAMPLE_GREATER_THAN:
            if (example.isCombineTypeOr()) {
            ...
            parms.put("id", example.getId());
            break;
        case ScPortalCfgExample.EXAMPLE_GREATER_THAN_OR_EQUAL:
            if (example.isCombineTypeOr()) {
            ...
            parms.put("id", example.getId());
            break;
        case ScPortalCfgExample.EXAMPLE_LESS_THAN:
            if (example.isCombineTypeOr()) {
            ...
            parms.put("id", example.getId());
            break;
        case ScPortalCfgExample.EXAMPLE_LESS_THAN_OR_EQUAL:
            if (example.isCombineTypeOr()) {
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getPORTAL_CODEExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
        ...
        case ScPortalCfgExample.EXAMPLE_LESS_THAN_OR_EQUAL:
            ...
            parms.put("portalCode", example.getPortalCode());
            break;
        case ScPortalCfgExample.EXAMPLE_LIKE:
            if (example.isCombineTypeOr()) {
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getTITLEExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getHREFExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getROW_NUMExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getCOL_NUMExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getSORTExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getDESCRIPTIONExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    private Map getExampleParms(ScPortalCfgExample example) {
        Map parms = new HashMap();
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public int selectCountByExample(ScPortalCfgExample example) {
        Map parms = getExampleParms(example);
        int count = ((Integer)getSqlMapClientTemplate().queryForObject("sc_portal_cfg.abatorgenerated_selectCountByExample", parms)).intValue();
        return count;
    }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public PageBox selectByExampleWithPaging(ScPortalCfgExample example, int pageSize, int pageNum, String orderByClause) {
        Map parms = getExampleParms(example);
        if (orderByClause != null) {
            parms.put("ABATOR_ORDER_BY_CLAUSE", orderByClause);
        }
        ...
        if (pageObject.getBeginIndex() <= pageObject.getItemAmount()) {
            pageList = (getSqlMapClientTemplate().queryForList("sc_portal_cfg.abatorgenerated_selectByExample", parms, pageObject.getBeginIndex() - 1, pageSize));
        }
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public PageBox selectByExampleWithPaging(ScPortalCfgExample example, int pageSize, int pageNum) {
     ...
     * @abatorgenerated Tue Nov 06 18:51:05 CST 2012
     */
    public int updateByPrimaryKeyForCgs(ScPortalCfg record) {
        int rows = getSqlMapClientTemplate().update("sc_portal_cfg.abatorgenerated_updateByPrimaryKeyForCgs", record);
        return rows;
    }
}