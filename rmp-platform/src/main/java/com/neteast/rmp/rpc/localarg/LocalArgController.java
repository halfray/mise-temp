...
package com.neteast.rmp.rpc.localarg;
...
import com.neteast.rmp.rpc.JSONRPCBridge;
import com.neteast.rmp.rpc.localarg.impl.HttpServletRequestArgResolver;
import com.neteast.rmp.rpc.localarg.impl.HttpServletResponseArgResolver;
import com.neteast.rmp.rpc.localarg.impl.HttpSessionArgResolver;
import com.neteast.rmp.rpc.localarg.impl.JSONRPCBridgeServletArgResolver;
...
public class LocalArgController
{
   ...
   */
  private final static org.apache.commons.logging.Log log = LogFactory.getLog(LocalArgController.class);
