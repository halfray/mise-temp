base.portal.dmWebsiteBelongevaluation = Ext.extend(Main.portal.PortalPage, {
    init : function(params) {
    		...
    		{header:'总流量',dataIndex:'all_Flow',hidden:false},
    		{header:'上行流量',dataIndex:'upload_Flow',hidden:false},
    	    {header:'下行流量',dataIndex:'download_Flow',hidden:false},
	    	...
	    	this.grid = new Ext.ux.Grid({
		    	dataMethod:'dmWebSiteBelongEvaluationAction.getWebSiteList',
				frame : false,
				border: false,
				bodyBorder : false,
				columns:columns,
