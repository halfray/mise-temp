base.portal.dmWebsiteBelongevaluationIP = Ext.extend(Main.portal.PortalPage, {
    init : function(params) {
    		...
    		{header:'域名引入率',dataIndex:'domainInRate',width:70,hidden:false,renderer:function(value){return (value*100).toFixed(2)+'%'}},
    		{header:'更新日期',dataIndex:'updatedate',width:70,hidden:false}
    		];
