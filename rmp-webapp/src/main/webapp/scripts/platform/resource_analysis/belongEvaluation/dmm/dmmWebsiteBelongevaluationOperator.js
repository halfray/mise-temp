base.portal.dmmWebsiteBelongevaluationOperator = Ext.extend(Main.portal.PortalPage, {
    init : function(params) {
    		...
    		{header:'运营商',dataIndex:'operator',width:90,hidden:false,renderer:Ext.ux.renderer.Combo(operator)},
    		{header:'域名数量',dataIndex:'domainNum',width:90,hidden:false},
    		{header:'域名引入率',dataIndex:'domainInRate',width:90,hidden:false,renderer:function(value){return (value*100).toFixed(2)+'%'}},
	    	...
	    	this.grid = new Ext.ux.Grid({
		    	dataMethod:'dmmWebSiteBelongEvaluationAction.getWebSiteOperatorList',
				frame : false,
				border: false,
				columns:columns,
		    	columnLines : true,
