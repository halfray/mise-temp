Ext.namespace('Ext.introduceEval.IntroduceListing');

Ext.introduceEval.IntroduceListing.SearchFormPanel = function(config){
//	var gridId = config.gridId;
	var webSiteID = config.webSiteID;
    // 初始化表单
    Ext.introduceEval.IntroduceListing.SearchFormPanel.superclass.constructor.call(this, Ext.applyIf(config, {
        border: false,
        labelAlign: 'right',
        buttonAlign: 'center',
...
Ext.extend(Ext.introduceEval.IntroduceListing.SearchFormPanel, Ext.FormPanel, {
