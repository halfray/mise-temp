 ...
 * 大文件归属评估二级平台-区域系统
 */
base.portal.dmmBigFileBelongProvinceSystem = Ext.extend(Main.portal.PortalPage, {
	init : function(params){
		...
		this.grid = new Ext.ux.Grid({
			dataMethod:'dmmBigFileBelongEvaluation2Action.getListBigFileBelongProvinceSystem',
			columns:gridColumns,
			height: 265,
			frame : false,
			border: false,
