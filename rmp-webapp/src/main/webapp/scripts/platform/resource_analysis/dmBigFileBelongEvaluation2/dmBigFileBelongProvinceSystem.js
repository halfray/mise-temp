 ...
 * 大文件归属评估二级平台-区域系统
 */
base.portal.dmBigFileBelongProvinceSystem = Ext.extend(Main.portal.PortalPage, {
	init : function(params){
		...
		this.grid = new Ext.ux.Grid({
			dataMethod:'dmBigFileBelongEvaluation2Action.getListBigFileBelongProvinceSystem',
			columns:gridColumns,
			height: 260,
			frame : false,
			border: false,
