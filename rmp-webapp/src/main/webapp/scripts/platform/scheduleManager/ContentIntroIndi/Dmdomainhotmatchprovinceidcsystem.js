base.portal.Dmdomainhotmatchprovinceidcsystem= Ext.extend(Main.portal.PortalPage, {
				...
				getMapData : function(data) {
					...
					if(data == null){
					 ...
					 var mapData=data;
					M.rpc._call(Main.fun.Fun(self, self.updateMapData),'contentIntroIndiAction.getListContentIeadIntoIndicat',{
