base.portal.PageDownloadSpeed= Ext.extend(Main.portal.PortalPage, {
				imports : ['/scripts/anychart/AnyChart.js',
							...
							init : function(params) {
								...
								getMapData : function(data) {
									...
									var mapData = data;								
									M.rpc._call(Main.fun.Fun(self, self.updateMapData),'dmQualityIndicatAction.getListPageDownloadSpeed',{
