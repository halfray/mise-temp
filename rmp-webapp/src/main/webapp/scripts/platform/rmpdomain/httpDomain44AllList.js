...
// -> Action URL
var URL = {
	queryList : 'httpDomain44ListProvider.do?provinceString=11',
...
new Ext.grid.RowNumberer(),
    {header: '所属区域', width: 100, sortable: true, dataIndex: EN[1], hidden: false, hideable: false,renderer:function(){return countryCombo.getRawValue()} },  
...
var countryCombo = new Ext.form.ComboBox({
                ...
                listeners:{
                	select:function()
                	{
                		URL.queryList = 'httpDomain44ListProvider.do?provinceString='+this.getValue();
                		Ext.getCmp('userGrid').getStore().proxy = new Ext.data.HttpProxy({
										url : URL.queryList
									});
                	}
                },
    ...
    Ext.override(Ext.ux.self.FormEditorGrid,{
        ...
        buildTbar : function(queryFields) {
        	...
        	handler : function() {
        		...
        		countryCombo.setValue(11);
        		URL.queryList = 'httpDomain44ListProvider.do?provinceString='+11;
               Ext.getCmp('userGrid').getStore().proxy = new Ext.data.HttpProxy({
										url : URL.queryList
									});
        		gridSelf.loadData();
