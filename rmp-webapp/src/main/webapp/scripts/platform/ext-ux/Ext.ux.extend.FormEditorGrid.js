Ext.ns("Ext.ux.extend");
Ext.ux.extend.FormEditor = Ext.extend(Ext.ux.seraph.FormEditor,{
	doSave : function() {
	var windowSelf = this;
...
Ext.ux.extend.FormEditorGrid = Ext.extend(Ext.ux.seraph.FormEditorGrid,{
	defaultvalue:{},
...
buildEditor : function() {
	// supply grid self
      var formEditor = new Ext.ux.extend.FormEditor(this, this.formPanel);
