base.portal.HTTPUserdistribution = Ext.extend(Main.portal.PortalPage, {
			...
			onPointClick : function(event) {
				...
				var conf = {
						href : 'portalAssemble.do?portalCode=otherFlowDistributedForApp&uxParams='+ encodeURI(Ext.encode(mydata)),
						text:  '',
						icon: '',
						height : '0.5',
						width : '0.7',
			...
			getMapData : function(data) {
				...
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'flowAnalysisAllAction.getAppFlowDistributed',{
