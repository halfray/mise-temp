base.portal.P2PFlowUserdistribution = Ext.extend(Main.portal.PortalPage, {
			...
			onPointClick : function(event) {
				var mydata = {};
				mydata.appName = event.data.Category;
				mydata.businessDate = this.data.bizDate;
				mydata.protocolType = 'P2P';
				var conf = {
						href : 'portalAssemble.do?portalCode=P2POtherDistribution&uxParams='+ encodeURI(Ext.encode(mydata)),
						text:  '',
						icon: '',
						height : '0.5',
						width : '0.7',
			...
			getMapData : function(data) {
				...
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'p2PAppAnalysisAction.getP2PAppAnalysisDIstribution',{
