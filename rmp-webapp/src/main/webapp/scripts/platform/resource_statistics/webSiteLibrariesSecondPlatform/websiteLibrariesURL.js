base.portal.websiteLibrariesURL = Ext.extend(Main.portal.PortalPage, {
			...
			getMapData : function(data) {
				...
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'dmNetsiteLibrariesDetailAction.getWebSiteLibrariesSecondPlatformForURL',{
			...
			updateMapData : function(data) {
				if(data != null){
					...
					this.pieData.setTitle('URL总数：'+'无数据');
					this.pieData.setPosition('right');
					this.pieChart.setJSData(this.pieData.getData());
				}
			},
