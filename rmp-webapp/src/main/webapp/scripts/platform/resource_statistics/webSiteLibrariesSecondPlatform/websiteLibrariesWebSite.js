base.portal.websiteLibrariesWebSite = Ext.extend(Main.portal.PortalPage, {
			...
			getMapData : function(data) {
				...
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'dmNetsiteLibrariesDetailAction.getWebSiteLibrariesSecondPlatformForWebSite',{
