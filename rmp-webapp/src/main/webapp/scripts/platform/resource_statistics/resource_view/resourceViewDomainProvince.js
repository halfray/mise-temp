base.portal.resourceViewDomainProvince = Ext.extend(Main.portal.PortalPage, {
			...
			getMapData : function() {
				var self = this;
				var mapData = {};
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'dmResourseViewSystemAction.getDomainProvince',{
