base.portal.P2PcacheOptimizeResult= Ext.extend(Main.portal.PortalPage, {
				...
				getMapData : function(data) {	
					var self = this;
					M.rpc._call(Main.fun.Fun(self, self.updateMapData), 'iDCKeyIndicatorAction.getIDCkeyIndicatorChartPanel','20130909');
				},
