 ...
 *TOP10分省热点网站网内外比例
 */
base.portal.resReportProvinceInOutTOP10 = Ext.extend(Main.portal.PortalPage, {
		...
		this.formPanel = new Ext.form.FormPanel({
        	...
        	items: [{
				...
				xtype: 'searchComboBox', 
						...
						dataParams: {'table': 'dm_resReport_province_webSite_inout_TOP10'},
						width : 120,
...
//						url: 'systemParmsProvider.do?type=TB_OP_W_0103_LIST&province=true',
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ResReportProvinceInOutTOP10ExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
