 ...
 *TOP10分省热点网站点击比例 
 */
base.portal.resReportProvinceTOP10 = Ext.extend(Main.portal.PortalPage, {
...
//						url: 'systemParmsProvider.do?type=TB_OP_W_0103_LIST&province=true',
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ResReportProvinceTOP10ExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
