 ...
 *TOP200分省热点域名网内外解析比例 
 */
base.portal.resReportProvinceTOP200 = Ext.extend(Main.portal.PortalPage, {
		...
		this.formPanel = new Ext.form.FormPanel({
        	...
        	items: [{
				...
				xtype: 'searchComboBox', 
						...
						dataParams: {'table': 'dm_resReport_province_domain_TOP200'},
						width : 120,
...
//						url: 'systemParmsProvider.do?type=TB_OP_W_0103_LIST&province=true',
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ResReportProvinceTOP200ExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
