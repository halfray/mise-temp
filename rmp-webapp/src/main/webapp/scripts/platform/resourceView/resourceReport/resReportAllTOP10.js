 ...
 *TOP10全网热点网站点击比例
 */
base.portal.resReportAllTOP10 = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
 				...
 				xtype: 'searchComboBox', 
						...
						dataParams: {table: 'dm_resReport_all_webSite_TOP10'},
						width : 120,
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ResReportAllTOP10ExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
