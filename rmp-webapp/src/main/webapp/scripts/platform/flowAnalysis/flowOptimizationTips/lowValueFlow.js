base.portal.lowValueFlow = Ext.extend(Main.portal.PortalPage, {
	init : function(params){
		...
		this.grid = new Ext.ux.Grid({
			dataMethod:'flowAnalysisAllAction.getLowAppTypeFlow',
			columns:gridColumns,
			height:160,
			root : 'result',
			frame : false,
	...
	onRowClick: function() {
		...
		var conf = {
				href : 'portalAssemble.do?portalCode=lowAppTypeFlow&uxParams='+ encodeURI(Ext.encode(this.data)),
				text:  '',
				icon: '',
				height : '0.8',
				width : '0.7',
