base.portal.userFlowDistributedFromBelong = Ext.extend(Main.portal.PortalPage, {
			...
			getMapData : function(data) {
				...
				var self = this;
				this.data = data;
				M.rpc._call(Main.fun.Fun(self, self.updateMapData),'flowAnalysisAllAction.getUserTypeFlowDistributedForIn',{
			...
			updateMapData : function(data) {
				...
				this.pieData.setTitle(this.data.provinceName);
