 ...
 *CDN引入报表
 */
base.portal.CDNReport = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
	                ...
	                items: [{
						...
						dataParams: {table: 'dm_allweb_incdnwebsite_report'},
						width : 120,
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "CDNExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
