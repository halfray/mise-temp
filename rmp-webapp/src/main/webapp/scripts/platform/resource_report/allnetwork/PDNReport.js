 ...
 *PDN引入报表
 */
base.portal.PDNReport = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
	                ...
	                items: [{
						...
						dataParams: {table: 'dm_allweb_inpdcwebsite_report'},
						width : 120,
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "PDCExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
