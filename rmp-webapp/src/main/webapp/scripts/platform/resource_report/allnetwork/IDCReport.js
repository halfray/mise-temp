 ...
 *IDC引入报表
 */
base.portal.IDCReport = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
	                ...
	                items: [{
						...
						dataParams: {table: 'dm_allweb_inidcwebsite_report'},
						width : 120,
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "IDCExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
