 ...
 *分省CDN引入报表
 */
base.portal.ProvinceCDNReport = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
	                ...
	                items: [{
						...
						dataParams: {'table': 'dm_allweb_province_incdnwebsite_report'},
						width : 120,
...
//						url: 'systemParmsProvider.do?type=TB_OP_W_0103_LIST',
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ProvinceCDNExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
