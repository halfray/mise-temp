 ...
 *分省PDC引入报表
 */
base.portal.ProvincePDCReport = Ext.extend(Main.portal.PortalPage, {
        	...
        	items: [{
	            ...
	            items: [{
	                ...
	                items: [{
						...
						dataParams: {'table': 'dm_allweb_province_inpdcwebsite_report'},
						width : 120,
...
//						url: 'systemParmsProvider.do?type=TB_OP_W_0103_LIST',
	                ...
	                items: [{
						...
						handler: function() {
							...
							var url = "ProvincePDCExportExcelAction.do?param="+encodeURIComponent(Ext.encode(data));
							window.open(url);
						}
	                }]
	            }]
