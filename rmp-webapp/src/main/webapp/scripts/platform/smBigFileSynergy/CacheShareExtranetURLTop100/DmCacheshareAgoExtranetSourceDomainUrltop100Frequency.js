base.portal.DmCacheshareAgoExtranetSourceDomainUrltop100Frequency = Ext.extend(Main.portal.PortalPage, {
	  ...
	  var columns = [
	                 ...
	                 {header:'次数',dataIndex:'URI',hidden:false}           
					  ...
					  var self=this;
					    ...
					    dataMethod:'cacheShareExtranetURLTop100Action.getListCacheshareAgoExtranetSourceDomainTOP100Frequency',
					    viewData:false,
						frame : false,
						border: false,
						columns:columns,
