base.portal.DmCacheshareAgoExtranetSourceDomainTOP100Flow = Ext.extend(Main.portal.PortalPage, {
	  ...
	  var columns = [
	                 ...
	                 {header:'流量(MB)',dataIndex:'sourceflow',hidden:false,renderer:Main.fun.getMFromByte}	                
					  ...
					  var self=this;
					    ...
					    dataMethod:'cacheShareExtranetDomainTop100Action.getListCacheshareAgoExtranetSourceDomainFlow',
					    viewData:false,
						frame : false,
						border: false,
						columns:columns,
