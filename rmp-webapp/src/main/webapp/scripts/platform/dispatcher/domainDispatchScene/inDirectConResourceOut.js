...
var columns = [new Ext.grid.RowNumberer(),sm,
  {header:'ID',dataIndex:'smInDirectconResourceOutId',hidden:true},
...
var reset = new Ext.Button({
   ...
   var grid = new Ext.ux.Grid({
    dataMethod:'smInDirectconResourceOutAction.getList',
	viewData:false,
	frame : false,
	border: false,
	columns:columns,
...
function operateDispatch(){
	...
	function onBoSave(){
		M.rpc._call(queryPolicyCallBack,'smInDirectconResourceOutAction.getConfigPolicy', '3');
		function queryPolicyCallBack(result){
			if(result){
				...
				if(form.isValid()){
					...
					M.rpc._call(saveDispatchCallBack,'smInDirectconResourceOutAction.saveDispatch', {
	...
	function queryPolicyCallBack(result){
		...
		function savePolicy(){
			...
			if(form.isValid()){
				...
				M.rpc._call(savepolicyCallBack,'smInDirectconResourceOutAction.savePolicy', {
