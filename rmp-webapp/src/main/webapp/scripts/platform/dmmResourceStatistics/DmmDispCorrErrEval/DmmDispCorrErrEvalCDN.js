base.portal.DmmDispCorrErrEvalCDN = Ext.extend(Main.portal.PortalPage, {
    init : function(params) {
	        	...
	        	var columns = [new Ext.grid.RowNumberer(),
	        	  ...
	        	  {header:'CDN资源命中率',dataIndex:'domainCDNRitRate',hidden:false,width:120,renderer:function(value){return (value*100).toFixed(2)+'%'}},
	        	...
	        	var self=this;
			    	...
			    	dataMethod:'dmmDispCorrErrEvalActoin.getListCDN',
			    	viewData:false,
					frame : false,
					border: false,
					columns:columns,
