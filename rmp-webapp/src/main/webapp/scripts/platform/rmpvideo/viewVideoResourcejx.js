...
// -> Action URL
var URL = {
	queryList : 'viewVideoResourceListProviderjx.do',
	action : 'viewVideoResourceActionjx.do'
};
...
var VideoUrlDetailWinHelp={
	ShowDetail : function (httpid,dpi){
		...
		VideoUrlDetailWin.html="<iframe id='myFrame' name='myFrame' width='920' height='420' src='httpVideodownurlListjx.do?hvd_qurey_params="+httpid+"AAA"+dpi+"'></iframe>"							
