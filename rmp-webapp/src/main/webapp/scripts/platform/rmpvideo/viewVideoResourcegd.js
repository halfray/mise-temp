/**
s * viewVideoResource.js Power by YUI-EXT and JSON.
 * 
 * @author 
 * @email 
 */
...
// -> Action URL
var URL = {
	queryList : 'viewVideoResourceListProvidergd.do',
	action : 'viewVideoResourceActiongd.do'
};
...
var VideoUrlDetailWinHelp={
	ShowDetail : function (httpid,dpi){
		...
		VideoUrlDetailWin.html="<iframe id='myFrame' name='myFrame' width='920' height='420' src='httpVideodownurlListgd.do?hvd_qurey_params="+httpid+"AAA"+dpi+"'></iframe>"							
