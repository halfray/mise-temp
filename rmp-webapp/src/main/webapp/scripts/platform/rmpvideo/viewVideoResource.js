...
// -> Action URL
var URL = {
	queryList : 'viewVideoResourceListProvider.do',
	action : 'viewVideoResourceAction.do'
};
...
var userColumns =[ 
    ...
    {header: CN[5], width: WD[5], sortable: true, dataIndex: EN[5], hidden: false, hideable: false,renderer: Ext.ux.renderer.Combo(hostField), editor: hostField},  
...
var VideoUrlDetailWinHelp={
	ShowDetail : function (httpid,dpi){
		...
		VideoUrlDetailWin.html="<iframe id='myFrame' name='myFrame' width='920' height='420' src='httpVideodownurlList.do?hvd_qurey_params="+httpid+"AAA"+dpi+"'></iframe>"							
