 ...
 * Authors : Jerome CARBOU
  */
Ext.ns('Ext.ux.form','Cls','Cls.form','Cls.menu');
...
Ext.ux.form.DateTimeField = Ext.extend(Ext.form.DateField, {
    ...
    onDestroy : function(){
        ...
        Ext.ux.form.DateTimeField.superclass.onDestroy.call(this);
    },
	
	// private
	validateBlur : function(){
		if (!Ext.ux.form.DateTimeField.superclass.validateBlur.call(this)){
			return false;
		}
		for(var i=this.timeFieldHandlers.length-1;i>=0;i--) {
