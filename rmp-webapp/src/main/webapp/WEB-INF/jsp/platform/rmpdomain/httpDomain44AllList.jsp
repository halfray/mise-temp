...
var provinceString = <%=(String)request.getAttribute("provinceString") %>
</script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/rmpdomain/httpDomain44AllList.js"></script>
</head>
