...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_analysis/introduceEval/pdc/introduceListing/IntroduceListingSearchFormPanel.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_analysis/introduceEval/pdc/introduceListing/IntroduceListingGridPanel.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_analysis/introduceEval/pdc/searchFormPanel.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_analysis/introduceEval/pdc/dmPDCIntroduceEval.js"></script>
</head>
<style>
