...
<title></title>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_analysis/depthAnalysis/dmWebsiteResourceEffectivedateWebsite.js"></script>
