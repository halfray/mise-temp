...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_statistics/dmDomainOverview/dmDomainIpHotDetail.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/platform/resource_statistics/dmDomainOverview/dmDomainOverview.js"></script>
